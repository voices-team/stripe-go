...
type SubscriptionAddInvoiceItemPriceDataParams struct {
...
type SubscriptionAddInvoiceItemParams struct {
	...
	PriceData *SubscriptionAddInvoiceItemPriceDataParams `form:"price_data"`
...
type SubscriptionParams struct {
	...
	BillingCycleAnchorTODOINCOMPATIBLECOMBINATION *string                                       `form:"billing_cycle_anchorTODO_INCOMPATIBLE_COMBINATION"`
	...
	Items                                         []*SubscriptionItemParams                     `form:"items"`

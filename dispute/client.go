...
func Close(id string, params *stripe.DisputeCloseParams) (*stripe.Dispute, error) {
	return getC().Close(id, params)
}

// Close is the method for the `POST /v1/disputes/{dispute}/close` API.
func (c Client) Close(id string, params *stripe.DisputeCloseParams) (*stripe.Dispute, error) {

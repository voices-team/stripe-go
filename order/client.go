...
func ReturnOrder(id string, params *stripe.OrderReturnOrderParams) (*stripe.Order, error) {
	return getC().ReturnOrder(id, params)
}

// ReturnOrder is the method for the `POST /v1/orders/{id}/returns` API.
func (c Client) ReturnOrder(id string, params *stripe.OrderReturnOrderParams) (*stripe.Order, error) {
